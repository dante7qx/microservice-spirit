...
public interface AuthorityRoleSQL {
	public final static String FIND_AUTHORITY_ROLE_BY_ROLE_ID = "select t.id, t.name, t.code, t.authority_desc as authorityDesc, t.show_order as showOrder, t.pid, t1.role_id as roleId"
														 + " from t_authority t "
